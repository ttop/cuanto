...
public class TestCaseParametersQueryModule implements QueryModule {


	/**
	 * If queryFilter.testCaseParameters is not null, then all returned outcomes must have this exact parameters string.
